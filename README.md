...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lively-water-34b9)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lively-water-34b9
```

A live public deployment of this template is available at [https://lively-water-34b9.templates.workers.dev](https://lively-water-34b9.templates.workers.dev)
